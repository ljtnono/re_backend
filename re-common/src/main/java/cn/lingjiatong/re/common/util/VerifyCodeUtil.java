...
public class VerifyCodeUtil {
    ...
    public static VerifyCodeUtil getInstance() {
        return VerifyCodeUtil.Holder.INSTANCE;
    }

    public static class Holder {
        private final static VerifyCodeUtil INSTANCE = new VerifyCodeUtil();
    }
     ...
     * @return 随机验证码
     */
    public String drawRandomText(BufferedImage bufferedImage) {
