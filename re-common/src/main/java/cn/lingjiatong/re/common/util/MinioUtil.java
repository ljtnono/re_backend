...
public class MinioUtil {
    ...
    public boolean isObjectExist(String bucketName, String objectName) {
        ...
        try {
            ...
            log.error("==========判断文件是否存在, 异常：{}", e.getMessage());
            exist = false;
        }
        return exist;
    }
    ...
    public boolean isFolderExist(String bucketName, String objectName) {
        ...
        try {
            ...
            log.error("==========判断文件夹是否存在，异常：{}", e.getMessage());
            exist = false;
        }
        return exist;
    }
     ...
     *
     * @param bucketName  存储桶
     * @param imageBase64 base64格式的图片
     * @param imageName   图片名
     * @return
     */
    public ObjectWriteResponse uploadImage(String bucketName, String imageBase64, String imageName) throws Exception {
    ...
    public void removeFiles(String bucketName, List<String> keys) {
        ...
        keys.forEach(s -> {
            ...
            try {
                ...
                log.error("==========批量删除文件，异常：{}", e.getMessage());
            }
        });
    }
