...
public interface BackendArticleFeignClient {
    ...
    ResultVO<?> publishArticle(@RequestBody BackendArticlePublishDTO dto);
    ...
    ResultVO<?> deleteDraft(@PathVariable("draftId") String draftId);
    ...
    ResultVO<?> deleteArticleBatch(@RequestBody BackendArticleDeleteBatchDTO dto);
    ...
    ResultVO<?> saveOrUpdateDraft(@RequestBody BackendDraftSaveOrUpdateDTO dto);
    ...
    ResultVO<?> updateArticleRecommendBatch(@RequestBody BackendArticleUpdateRecommendBatchDTO dto);
    ...
    ResultVO<?> updateArticleTopBatch(@RequestBody BackendArticleUpdateTopBatchDTO dto);
    ...
    ResultVO<BackendDraftDetailVO> getDraftDetail(@PathVariable("draftId") String draftId);
    ...
    ResultVO<List<BackendDraftListVO>> getDraftList();
    ...
    ResultVO<Page<BackendArticleListVO>> findArticleList(@SpringQueryMap BackendArticleListDTO dto);
