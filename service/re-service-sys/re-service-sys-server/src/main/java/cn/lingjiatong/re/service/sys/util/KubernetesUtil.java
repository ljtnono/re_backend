...
public class KubernetesUtil {
    ...
    private static final String ENDPOINT = "https://www.lingjiatong.cn:6443";
    private static final String TOKEN = "eyJhbGciOiJSUzI1NiIsImtpZCI6IlUxX0lfTkJIXzkwajk0M256TzdkVTRCaUV2UEhMb0l2azJhandrNjVzSnMifQ..haY0p189dZc0XrGHhuTECEBzeOtkhYRQYcqgJo-4qxAnFAqiTAoMOE1Kv3BXQTvNrsH9-Vej09Ba-p59K-9bVAyoMKogpqa0Se9n7bNKBfObcAxnm3PrpP2UtQOhaaSWdywGG7ATgwnsH7hjPUyQNHCuaLh4Wq2EzuDY8j_mXtm_BQqH5UlhqBniOXPf850yWRu6CyzVhM3ENyMQQXbZxyYCSf0OoxyqKLQUza3OAQEBD5bWkYMAfHIgRzbzbCFT8sjG8Xz7OETS56P1gUPQKBAvf0uzxQSrAK6scMKSwB8E6L7zzAaKDkNAb20ZfC5x6qUFb8Gqfk_dG0JheNHwOg";
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ApiClient connection = kubernetesUtil.initClient();
        V1NodeList nodeList = kubernetesUtil.getNodeList();
        List<V1Node> items = nodeList.getItems();
        for (V1Node v1Namespace : items) {

            System.out.println(JSONUtil.objectToString(v1Namespace));
        }
